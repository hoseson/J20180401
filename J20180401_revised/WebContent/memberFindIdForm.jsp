...
<body>
	...
	<section> <script type="text/javascript">
		function findInfo() {
			...
			window.open("sendMail.do?email=" + frm.email.value + "&tel="
					+ frm.tel.value, "", "width=500 height=300");
		}
	</script>
	<div align="center">
		<div>
			<img width="1000px" height="150px" src="images/idFindMenu.jpg" />
		</div>
		<div align="center"
				...
				<table align="center" style="width: 560px">
					...
					<tr>
						<td colspan="2"><input type="button" value="인증번호 전송"
							...
							<a href="memberFindPwForm.jsp"><input type="button"
								value="비밀번호 찾기"
