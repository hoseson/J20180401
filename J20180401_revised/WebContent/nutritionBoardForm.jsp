...
<body>
	...
	<div align="center">
		<div>
			<img width="1000px" height="150px" src="images/nutritioninfo.jpg">
		</div>
		<!-- 게시물 검색  -->
		<div
			...
			<div class="board">
				...
				<table align="center">
					...
					<c:forEach var="li" items="${list}">
						...
						<td><div class="box"
								onclick="location.href='boardForm.do?boardType=${boardType }&boardno=${li.boardno }&subject=${li.subject }&content=${li.content }&regdate=${li.regdate }&readcount=${li.readcount }'">
								<div class="subject">[영양정보] ${li.subject }</div>
