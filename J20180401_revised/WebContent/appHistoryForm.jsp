...
<body>
	...
	<div align="center">
		...
		<div
			...
			<form action="appHistory.do">
				<h3>진료 내역</h3>
				<div style="text-align: left;">
					<p>
						<input type="hidden" name="memNo" value="${memNo }"> 
						기간 1 : <input type="text" id="datepicker" name="date1" placeholder="검색할 날짜를 입력해주세요" value="${date1 }"> 
						기간 2 : <input type="text" id="datepicker2" name="date2" placeholder="검색할 날짜를 입력해주세요" value="${date2 }">
						
						<input	type="submit" value="기간 검색" style="width: 100px; height: 30px; 
						background-color: #4F81BC; font-family: '휴먼모음T'; font-size: 20px; color: white;">
					</p>
				</div>
