	...
	<div align="center">
		...
		<div
			...
			<table width="800px" align="center">
				...
				<tr>
					<td colspan="3"><h3>[${board.type }] ${board.subject }</h3></td>
				</tr>
				<tr>
				...
				<tr>
					<p>
						<c:if test="${prevPage.type != null}">
							<td colspan="3"><a
								href="boardForm.do?boardType=${boardType }&boardno=${prevPage.boardno }&type=${prevPage.type}&subject=${prevPage.subject}&content=${prevPage.content}&regdate=${prevPage.regdate}">▲이전
									페이지 / [${prevPage.type }] ${prevPage.subject }</a></td>
						</c:if>
					</p>
				</tr>
				<tr>
					<p>
						<c:if test="${nextPage.type != null}">
							<td colspan="3"><a
								href="boardForm.do?boardType=${boardType }&boardno=${nextPage.boardno }&type=${nextPage.type}&subject=${nextPage.subject}&content=${nextPage.content}&regdate=${nextPage.regdate}">▼다음
									페이지 / [${nextPage.type }] ${nextPage.subject }</a></td>
						</c:if>
					</p>
				</tr>
				<tr>
