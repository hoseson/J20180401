...
<body>
	...
	<div align="center">
		<div
			...
			<div>
				<form action="updateContentPro.do">
					<table align="center">
						<input type="hidden" name="boardType" value="${boardType }">
						<input type="hidden" name="boardno" value="${boardno }">
						<tr>
							<td>제목</td>
							<td><input type="text" name="subject" width="500"
								value="${subject }" size="98"></td>
						</tr>
						<tr>
							<td>내용</td>
							<td><textarea name="content" cols="100" rows="30"
									style="resize: none;">${content }</textarea>
						</tr>
						<tr>
							<td align="center" colspan="2"><input type="submit"
								value="수정"><input type="reset" value="다시 쓰기"></td>
						</tr>
					</table>
				</form>
			</div>
